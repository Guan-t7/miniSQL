...
void IndexManager::IndexInsertion(int Type, string IndexName, string Key,value Address)
{
	ConvertKey(Type,Key);
	if(Type == -1)
	{
...
void IndexManager::IndexUpdate(int Type, string IndexName, string Key, value Address)
{
	ConvertKey(Type,Key);
	if(Type == -1)
	{
