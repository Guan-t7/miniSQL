...
void sqlParser::OpGTEContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<sqlParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterOpGTE(this);
}
void sqlParser::OpGTEContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<sqlParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitOpGTE(this);
}

antlrcpp::Any sqlParser::OpGTEContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<sqlParserVisitor*>(visitor))
    return parserVisitor->visitOpGTE(this);
  else
    return visitor->visitChildren(this);
}
//----------------- OpEQContext ------------------------------------------------------------------
...
void sqlParser::OpEQContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<sqlParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterOpEQ(this);
}
void sqlParser::OpEQContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<sqlParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitOpEQ(this);
}

antlrcpp::Any sqlParser::OpEQContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<sqlParserVisitor*>(visitor))
    return parserVisitor->visitOpEQ(this);
  else
    return visitor->visitChildren(this);
}
//----------------- OpNEQContext ------------------------------------------------------------------
...
void sqlParser::OpNEQContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<sqlParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterOpNEQ(this);
}
void sqlParser::OpNEQContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<sqlParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitOpNEQ(this);
}

antlrcpp::Any sqlParser::OpNEQContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<sqlParserVisitor*>(visitor))
    return parserVisitor->visitOpNEQ(this);
  else
    return visitor->visitChildren(this);
}
//----------------- OpGTContext ------------------------------------------------------------------
...
void sqlParser::OpGTContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<sqlParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterOpGT(this);
}
void sqlParser::OpGTContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<sqlParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitOpGT(this);
}

antlrcpp::Any sqlParser::OpGTContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<sqlParserVisitor*>(visitor))
...
void sqlParser::OpLTEContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<sqlParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterOpLTE(this);
}
void sqlParser::OpLTEContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<sqlParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitOpLTE(this);
}

antlrcpp::Any sqlParser::OpLTEContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<sqlParserVisitor*>(visitor))
    return parserVisitor->visitOpLTE(this);
  else
    return visitor->visitChildren(this);
}
//----------------- OpLTContext ------------------------------------------------------------------
...
void sqlParser::OpLTContext::enterRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<sqlParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->enterOpLT(this);
}
void sqlParser::OpLTContext::exitRule(tree::ParseTreeListener *listener) {
  auto parserListener = dynamic_cast<sqlParserListener *>(listener);
  if (parserListener != nullptr)
    parserListener->exitOpLT(this);
}

antlrcpp::Any sqlParser::OpLTContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<sqlParserVisitor*>(visitor))
...
std::vector<std::string> sqlParser::_symbolicNames = {
  ...
  "DQUOTA_STRING", "SQUOTA_STRING", "TOKEN", "ERROR_RECONGNIGION"
};
...
sqlParser::Initializer::Initializer() {
  ...
  _serializedATN = {
    ...
    0x2f, 0x3, 0x2, 0x2, 0x2, 0xc6, 0xc7, 0x7, 0x2d, 0x2, 0x2, 0xc7, 0x31, 
    0x3, 0x2, 0x2, 0x2, 0xc8, 0xc9, 0x7, 0x2d, 0x2, 0x2, 0xc9, 0x33, 0x3, 
    0x2, 0x2, 0x2, 0xca, 0xcb, 0x7, 0x2d, 0x2, 0x2, 0xcb, 0x35, 0x3, 0x2, 
